...
public class TextureCamera implements SurfaceTextureHelper.OnTextureFrameAvailableListener {
  private static final String TAG = TextureCamera.class.getSimpleName();
  ...
  public void onTextureFrameAvailable(int oesTextureId, float[] transformMatrix, long timestampNs) {
    int rotation = getFrameOrientation(context, info);
    ...
    surfaceTextureHelper.returnTextureFrame(); // fixme
  }
  ...
  private static int getFrameOrientation(Context context, Camera.CameraInfo info) {
    int rotation = getDeviceOrientation(context);
